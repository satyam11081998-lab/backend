...
# Copied services/interviewer_mode.py on 2026-09-23 for the role/company-aware Prep Copilot (v2).
...
def select_mode(sig: Dict[str, Any], policy: str = "coached",
    ...
    from services.copilot.engine.interviewer_decision import evaluate_intervention_gate
